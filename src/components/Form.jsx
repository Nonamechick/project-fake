...
const Form = () => {
    ...
    const validate = e => {
        ...
        if (password.length > 8) {
            ...
            setErrorPassword('password should be 8 letters')
        ...
        if(password != '' && password == confirmPassword) {
            ...
            setErrorConfirmPassword('password should be same')
    ...
    <>
        <div className="card">
            ...
            <form>
                ...
                <input type="password" placeholder='Confirm Password' style={{ borderColor: confirmPasswordColor}} 
